...
The workflows run in either harness: the `coding-peers` peer table resolves peers, models,
...
rewrite provider names by hand; that table is the only place a peer is named.
